...
hl.animation({ leaf = "windows",       enabled = true, speed = 2.79, spring = "niriSpring" })
hl.animation({ leaf = "windowsIn",     enabled = true, speed = 2.1,  spring = "niriSpring", style = "popin 87%" })
...
hl.bind(mainMod .. " + W", sh("/home/joe/.config/hypr/scripts/cycle-layout.sh"), { repeating = false, description = "Cycle layout: dwindle/master/scrolling" })
...
hl.bind(mainMod .. " + mouse_down", hl.dsp.layout("move +col"), { mouse = true, description = "Scroll to next column" })
hl.bind(mainMod .. " + mouse_up", hl.dsp.layout("move -col"), { mouse = true, description = "Scroll to previous column" })
hl.bind(mainMod .. " + mouse_right", hl.dsp.layout("move -col"), { mouse = true, description = "Scroll right to previous column" })
hl.bind(mainMod .. " + mouse_left", hl.dsp.layout("move +col"), { mouse = true, description = "Scroll left to next column" })
